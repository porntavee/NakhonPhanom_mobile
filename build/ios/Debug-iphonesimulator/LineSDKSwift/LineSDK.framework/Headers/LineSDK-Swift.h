...
#ifndef LINESDK_SWIFT_H
#define LINESDK_SWIFT_H
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC7LineSDK25StyleNavigationController")
...
SWIFT_CLASS("_TtC7LineSDK36OpenChatCreatingNavigationController")
